...
| Adopted document/article without verified redistribution | `docs/coding-agent-kit/knowledge/collection/link-references.json`; URL and original annotation only |
