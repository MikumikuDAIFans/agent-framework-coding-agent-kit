# Source review: `official-learn-hub`

## Snapshot

- Source: Microsoft Agent Framework documentation
- Canonical URL: https://learn.microsoft.com/en-us/agent-framework/
...
- Languages: navigation for C#, Python, and the separately maintained Go SDK.
- MAF topics: getting-started.
- Target evidence: `docs/coding-agent-kit/catalog/learn-index.json`; target source roots `dotnet/`, `python/`, `declarative-agents/`, and `schemas/`.
- Version/maturity: Navigation page; individual linked features have their own stable, preview, or experimental status.
...
- Important correspondence or drift: The live hub now links Agent Harness and the separately maintained Go SDK. Neither is evidence that a Go implementation exists in this target repository; follow the linked feature page and exact package/revision.

## Design and implementation value

- Reusable decisions: Canonical route map from first agent through tools, conversations, workflows, integrations, migration, and API reference.
...
- Prohibited shortcut: Do not cite the hub as an API contract, package-version guarantee, or production-readiness proof.
...
- Prohibited or unsafe use: Do not cite the hub as an API contract, package-version guarantee, or production-readiness proof.
