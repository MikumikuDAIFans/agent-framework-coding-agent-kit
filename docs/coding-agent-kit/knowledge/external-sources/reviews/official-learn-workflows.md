# Source review: `official-learn-workflows`

## Snapshot

- Source: Workflows overview
- Canonical URL: https://learn.microsoft.com/en-us/agent-framework/workflows/
- Source class: `official-doc`
- Owner/author: Microsoft Learn / Microsoft
- Reviewed page date: 2026-04-29
...
- Languages: C# and Python; Go coverage is separate and incomplete.
- MAF topics: workflows, orchestration, durability.
- Target evidence: `python/packages/core/agent_framework/_workflows`; `dotnet/src/Microsoft.Agents.AI.Workflows`; `dotnet/tests/Microsoft.Agents.AI.Workflows.UnitTests`; workflow samples.
- Version/maturity: Graph workflow API is the main route; Python functional workflow is explicitly experimental.
...
- Important correspondence or drift: Graph concepts exist in target C#/Python source. Functional workflow has different replay/caching semantics and no C# counterpart.

## Design and implementation value

- Reusable decisions: Canonical choice between graph workflows and Python functional workflows, with executors, edges, events, checkpointing, and HITL.
...
- Prohibited shortcut: Do not assume agentic orchestration provides deterministic business rules, unbounded loop safety, compensation, or exactly-once side effects.
...
- State: `adopted`
- Approved use: primary official explanation and routing source for **workflows, orchestration, durability**, always paired with target revision/package coordinates and matching source/tests.
- Prohibited or unsafe use: Do not assume agentic orchestration provides deterministic business rules, unbounded loop safety, compensation, or exactly-once side effects.
