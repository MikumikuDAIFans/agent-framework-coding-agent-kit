# Source review: `official-learn-observability`

## Snapshot

- Source: Observability
- Canonical URL: https://learn.microsoft.com/en-us/agent-framework/agents/observability
- Source class: `official-doc`
- Owner/author: Microsoft Learn / Microsoft
- Reviewed page date: 2026-07-01
...
- MAF topics: observability.
- Target evidence: `docs/decisions/0003-agent-opentelemetry-instrumentation.md`; `python/packages/core/agent_framework/_telemetry.py`; `dotnet/src/Microsoft.Agents.AI/OpenTelemetryAgent.cs`; observability tests and samples.
- Version/maturity: OpenTelemetry integration is current; exported semantic attributes and provider coverage can evolve.
...
- Important correspondence or drift: Target telemetry seams correspond to C#/Python guidance; live Go middleware is a separate SDK. Attribute presence is not a stable public persistence schema.

## Design and implementation value

- Reusable decisions: Canonical tracing route for agents, model calls, tools, workflows, and exporters.
...
- Prohibited shortcut: Do not record secrets, raw private prompts, tool payloads, or identity data without explicit redaction and retention controls.
...
- State: `adopted`
- Approved use: primary official explanation and routing source for **observability**, always paired with target revision/package coordinates and matching source/tests.
- Prohibited or unsafe use: Do not record secrets, raw private prompts, tool payloads, or identity data without explicit redaction and retention controls.
- Topic-registry promotion proposal: route under `observability`; preserve all additional topic tags from `sources.json`.
