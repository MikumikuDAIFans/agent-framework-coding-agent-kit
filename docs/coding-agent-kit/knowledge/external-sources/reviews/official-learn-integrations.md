# Source review: `official-learn-integrations`

## Snapshot

- Source: Agent Framework integrations
- Canonical URL: https://learn.microsoft.com/en-us/agent-framework/integrations/
- Source class: `official-doc`
- Owner/author: Microsoft Learn / Microsoft
- Reviewed page date: 2026-04-09
...
- Languages: C# and Python with protocol/provider-specific differences.
- MAF topics: protocols, hosting, providers.
- Target evidence: `python/packages`; `dotnet/src`; `docs/decisions/0010-ag-ui-support.md`; `docs/features/vector-stores-and-embeddings/README.md`.
- Version/maturity: Directory page mixes stable, preview, experimental, Microsoft, and third-party integrations.
...
- Important correspondence or drift: The page itself warns that connector ownership, SDK support, licensing, and version compatibility vary. Presence in the list is not target-revision support proof.

## Design and implementation value

- Reusable decisions: Canonical discovery map for A2A, AG-UI, Durable Task, DevUI, memory/vector stores, security, and hosted/provider integrations.
...
- Prohibited shortcut: Do not adopt a connector without separate package, license, data-flow, identity, support, and operational review.
...
- State: `adopted`
- Approved use: primary official explanation and routing source for **protocols, hosting, providers**, always paired with target revision/package coordinates and matching source/tests.
- Prohibited or unsafe use: Do not adopt a connector without separate package, license, data-flow, identity, support, and operational review.
